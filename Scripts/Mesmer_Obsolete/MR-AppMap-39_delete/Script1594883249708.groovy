...
//AppMap-39 | Behavior when user changes the crawl duration when the crawl is already in progress
											...
											if(WebUI.waitForElementVisible(ThreeDotButton,10)==true){
												...
												if(WebUI.waitForElementVisible(ConfigureCrawlOption,5)==true){
													...
													if(WebUI.waitForElementVisible(InputTimeInMinutes, 10)==true){
														...
														WebUI.delay(1)
														WebUI.sendKeys(InputTimeInMinutes, timeInMinutes2)
													...
													KeywordUtil.markFailed("FAILED: Unable to set times in minutes")
													}
												}else{
