...
// AppMap-41 | Verify the status of devices available to run a crawl gets updated
...
//										if(WebUI.waitForElementVisible(crawlComplete,1200)==true){
											...
											if(WebUI.waitForElementVisible(ThreeDotButton,10)==true){
												...
												if(WebUI.waitForElementVisible(ConfigureCrawlOption,5)==true){
													...
													if(WebUI.waitForElementVisible(inUseDeviceText, 10)==true){
														...
														KeywordUtil.markFailed("FAILED: No Inuse device in configure crawl screen")
													}
												}else{
