								...
								if(WebUI.waitForElementVisible(reDoFromHere, 60)){
									...
									if(WebUI.waitForElementVisible(selectDeviceOption, 60)){
										...
										if(devicesList != null && devicesList.size() > 0){
											...
											KeywordUtil.markPassed("PASSED: MS-ManageTest-21 successfull")
//											List<WebElement> inUseDevicesList = driver.findElements(By.xpath('//div[@class="device inUse selected ng-star-inserted"]'))
...
//												}
//												else{
//													KeywordUtil.markFailed("FAILED: There is no provisioned device available")
//												}
//											}
										}
										else{
