...
// MR-Device Manager-14 | Verify all connected devices (physical or virtual) are showing on Device Manager page
...
try{
		...
		MesmerLogUtils.logInfo("Total Number of Devices " + " : "  +   totalDevices )
