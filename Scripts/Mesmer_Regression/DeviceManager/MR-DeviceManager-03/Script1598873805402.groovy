...
// MR-Device Manager-03 | Verify User can select any devices filters from Device Manager page
...
def checkiOSPhysicalDevices(){
	...
	if(countIOSPhysicalDevices > 0){
		...
		MesmerLogUtils.logInfo("No iOS Physical Device available")
	}	
...
def checkiOSVirtualDevices(){
	...
	if(countIOSVirtualDevices > 0){
		...
		MesmerLogUtils.logInfo("No iOS Virtual Device available")
	}
...
def checkAndroidPhysicalDevices(){
	...
	if(countAndroidPhysicalDevices > 0){
		...
		MesmerLogUtils.logInfo("No Android Physical Device available")
	}
...
def checkAndroidVirtualDevices(){
	...
	if(countAndroidVirtualDevices > 0){
		...
		MesmerLogUtils.logInfo("No Android Virtual Device available")
	}
