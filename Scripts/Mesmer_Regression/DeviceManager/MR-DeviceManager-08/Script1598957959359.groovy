...
// MR-Device Manager-08 | Verify there is a Platform column that lists down devices paltforms (iOS/Android) with their OS verison and platform icons
...
//			}
		...
		if(inUseiOSCount > 0){
			...
			for (WebElement webElement : listOfDevicesTypeiOSInUse) {
				MesmerLogUtils.logInfo("InUse iOS devices is Virtual ")
			}
