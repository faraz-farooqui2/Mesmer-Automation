...
def deviceManagerList(){
	...
	if(WebUI.waitForElementVisible(allDevicesOptionActive, 2)==false){
		...
		listDeviceUDIDiOSReady = deviceUDIDListiOSReady.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSReady = driver.findElements(By.xpath(listDeviceUDIDiOSReady))

		listDeviceUDIDAndroidReady = deviceUDIDListAndroidReady.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidReady = driver.findElements(By.xpath(listDeviceUDIDAndroidReady))

		listDeviceUDIDiOSInUse = deviceUDIDListiOSInUse.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSInUse = driver.findElements(By.xpath(listDeviceUDIDiOSInUse))

		listDeviceUDIDAndroidInUse = deviceUDIDListAndroidInUse.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidInUse = driver.findElements(By.xpath(listDeviceUDIDAndroidInUse))

		listDeviceUDIDiOSProv = deviceUDIDListiOSProv.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSProv = driver.findElements(By.xpath(listDeviceUDIDiOSProv))

		listDeviceUDIDAndroidProv = deviceUDIDListAndroidProv.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidProv = driver.findElements(By.xpath(listDeviceUDIDAndroidProv))

		listDeviceUDIDiOSBroken = deviceUDIDListiOSBroken.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSBroken = driver.findElements(By.xpath(listDeviceUDIDiOSBroken))

		listDeviceUDIDAndroidBroken = deviceUDIDListAndroidBroken.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidBroken = driver.findElements(By.xpath(listDeviceUDIDAndroidBroken))

		listDeviceUDIDiOSUnavailable = deviceUDIDListiOSUnavailable.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSUnavailable = driver.findElements(By.xpath(listDeviceUDIDiOSUnavailable))

		listDeviceUDIDAndroidUnavailable = deviceUDIDListAndroidUnavailable.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidUnavailable = driver.findElements(By.xpath(listDeviceUDIDAndroidUnavailable))

		listDeviceUDIDiOSConfiguring = deviceUDIDListiOSConfiguring.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSConfiguring = driver.findElements(By.xpath(listDeviceUDIDiOSConfiguring))

		listDeviceUDIDAndroidConfiguring = deviceUDIDListAndroidConfiguring.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidConfiguring = driver.findElements(By.xpath(listDeviceUDIDAndroidConfiguring))

		listDeviceUDIDiOSRefreshing = deviceUDIDListiOSRefreshing.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSRefreshing = driver.findElements(By.xpath(listDeviceUDIDiOSRefreshing))

		listDeviceUDIDAndroidRefreshing = deviceUDIDListAndroidRefreshing.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidRefreshing = driver.findElements(By.xpath(listDeviceUDIDAndroidRefreshing))

		listDeviceUDIDiOSRebooting = deviceUDIDListiOSRebooting.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDiOSRebooting = driver.findElements(By.xpath(listDeviceUDIDiOSRebooting))

		listDeviceUDIDAndroidRebooting = deviceUDIDListAndroidRebooting.findPropertyValue('xpath').toString()
		List<WebElement> listOfDevicesUDIDAndroidRebooting = driver.findElements(By.xpath(listDeviceUDIDAndroidRebooting))
		...
		if(readyiOSCount > 0){
			...
			for (WebElement webElement : listOfDevicesUDIDiOSReady) {
		...
		if(readyAndroidCount > 0){
			...
			for (WebElement webElement : listOfDevicesUDIDAndroidReady) {
				String deviceUDIDAndroidReadyListText = webElement.getText();
				MesmerLogUtils.logInfo("Ready Android Device UDID " + " : " + "  "  +  deviceUDIDAndroidReadyListText)
			}
		}
		else{
		...
		if(inUseiOSCount > 0){
			...
			//				MesmerLogUtils.logInfo("Ready iOS devices is Virtual ")
			//			}
			//			for (WebElement webElement : listOfDevicesResolutioniOSInUse) {
			//				String deviceResolutioniOSInUseListText = webElement.getText();
			//				MesmerLogUtils.logInfo("InUse iOS Device Resolution " + " : " + "  "  +  deviceResolutioniOSInUseListText)
			//			}

			for (WebElement webElement : listOfDevicesUDIDiOSInUse) {
		...
		if(inUseAndroidCount > 0){
			...
			//			for (WebElement webElement : listOfDevicesResolutionAndroidInUse) {
			//				String deviceResolutionAndroidInUseListText = webElement.getText();
			//				MesmerLogUtils.logInfo("InUse Android Device Resolution " + " : " + "  "  +  deviceResolutionAndroidInUseListText)
			//			}

			for (WebElement webElement : listOfDevicesUDIDAndroidInUse) {
				String deviceUDIDAndroidInUseListText = webElement.getText();
				MesmerLogUtils.logInfo("InUse Android Device UDID " + " : " + "  "  +  deviceUDIDAndroidInUseListText)
			}
		...
		if(provisionediOSCount > 0){
			...
			for (WebElement webElement : listOfDevicesUDIDiOSProv) {
		...
		if(provisionedAndroidCount > 0){
			...
			for (WebElement webElement : listOfDevicesUDIDAndroidProv) {
		...
		if(brokeniOSCount > 0){
			...
			//			}
			//			for (WebElement webElement : listOfDevicesResolutioniOSBroken) {
			//				String deviceResolutioniOSBrokenListText = webElement.getText();
			//				MesmerLogUtils.logInfo("Broken iOS Device Resolution " + " : " + "  "  +  deviceResolutioniOSBrokenListText)
			//			}

			for (WebElement webElement : listOfDevicesUDIDiOSBroken) {
				String deviceUDIDiOSBrokenListText = webElement.getText();
				MesmerLogUtils.logInfo("Broken iOS Device UDID " + " : " + "  "  +  deviceUDIDiOSBrokenListText)
			}
...
//			for (WebElement webElement : listOfDevicesResolutionAndroidBroken) {
//				String deviceResolutionAndroidBrokenListText = webElement.getText();
//				MesmerLogUtils.logInfo("Broken Android Device Resolution " + " : " + "  "  +  deviceResolutionAndroidBrokenListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDAndroidBroken) {
				String deviceUDIDAndroidBrokenListText = webElement.getText();
				MesmerLogUtils.logInfo("Broken Android Device UDID " + " : " + "  "  +  deviceUDIDAndroidBrokenListText)
			}
		}
		else{
...
//			for (WebElement webElement : listOfDevicesResolutioniOSUnavailable) {
//				String deviceResolutioniOSUnavailableListText = webElement.getText();
//				MesmerLogUtils.logInfo("Unavailable iOS Device Resolution " + " : " + "  "  +  deviceResolutioniOSUnavailableListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDiOSUnavailable) {
				String deviceUDIDiOSUnavailableListText = webElement.getText();
				MesmerLogUtils.logInfo("Unavailable iOS Device UDID " + " : " + "  "  +  deviceUDIDiOSUnavailableListText)
			}
...
//			for (WebElement webElement : listOfDevicesResolutionAndroidUnavailable) {
//				String deviceResolutionAndroidUnavailableListText = webElement.getText();
//				MesmerLogUtils.logInfo("Unavailable Android Device Resolution " + " : " + "  "  +  deviceResolutionAndroidUnavailableListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDAndroidUnavailable) {
				String deviceUDIDAndroidUnavailableListText = webElement.getText();
				MesmerLogUtils.logInfo("Unavailable Android Device UDID " + " : " + "  "  +  deviceUDIDAndroidUnavailableListText)
			}
		}
		else{
...
//			for (WebElement webElement : listOfDevicesResolutioniOSConfiguring) {
//				String deviceResolutioniOSConfiguringListText = webElement.getText();
//				MesmerLogUtils.logInfo("Configuring iOS Device Resolution " + " : " + "  "  +  deviceResolutioniOSConfiguringListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDiOSConfiguring) {
				String deviceUDIDiOSConfiguringListText = webElement.getText();
				MesmerLogUtils.logInfo("Configuring iOS Device UDID " + " : " + "  "  +  deviceUDIDiOSConfiguringListText)
			}
...
//			for (WebElement webElement : listOfDevicesResolutionAndroidConfiguring) {
//				String deviceResolutionAndroidConfiguringListText = webElement.getText();
//				MesmerLogUtils.logInfo("Configuring Android Device Resolution " + " : " + "  "  +  deviceResolutionAndroidConfiguringListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDAndroidConfiguring) {
				String deviceUDIDAndroidConfiguringListText = webElement.getText();
				MesmerLogUtils.logInfo("Configuring Android Device UDID " + " : " + "  "  +  deviceUDIDAndroidConfiguringListText)
			}
		}
		else{
...
//			for (WebElement webElement : listOfDevicesResolutioniORefreshing) {
//				String deviceResolutioniOSRefreshingListText = webElement.getText();
//				MesmerLogUtils.logInfo("Refreshing iOS Device Resolution " + " : " + "  "  +  deviceResolutioniOSRefreshingListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDiOSRefreshing) {
				String deviceUDIDiOSRefreshingListText = webElement.getText();
				MesmerLogUtils.logInfo("Refreshing iOS Device UDID " + " : " + "  "  +  deviceUDIDiOSRefreshingListText)
			}
...
//			for (WebElement webElement : listOfDevicesResolutionAndroidRefreshing) {
//				String deviceResolutionAndroidRefreshingListText = webElement.getText();
//				MesmerLogUtils.logInfo("Refreshing Android Device Resolution " + " : " + "  "  +  deviceResolutionAndroidRefreshingListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDAndroidRefreshing) {
				String deviceUDIDAndroidRefreshingListText = webElement.getText();
				MesmerLogUtils.logInfo("Refreshing Android Device UDID " + " : " + "  "  +  deviceUDIDAndroidRefreshingListText)
			}
...
//			for (WebElement webElement : listOfDevicesResolutioniOSRebooting) {
//				String deviceResolutioniOSRebootingListText = webElement.getText();
//				MesmerLogUtils.logInfo("Rebooting iOS Device Resolution " + " : " + "  "  +  deviceResolutioniOSRebootingListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDiOSRebooting) {
				String deviceUDIDiOSRebootingListText = webElement.getText();
				MesmerLogUtils.logInfo("Rebooting iOS Device UDID " + " : " + "  "  +  deviceUDIDiOSRebootingListText)
			}
...
//			for (WebElement webElement : listOfDevicesResolutionAndroidRebooting) {
//				String deviceResolutionAndroidRebootingListText = webElement.getText();
//				MesmerLogUtils.logInfo("Rebooting Android Device Resolution " + " : " + "  "  +  deviceResolutionAndroidRebootingListText)
//			}

			for (WebElement webElement : listOfDevicesUDIDAndroidRebooting) {
				String deviceUDIDAndroidRebootingListText = webElement.getText();
				MesmerLogUtils.logInfo("Rebooting Android Device UDID " + " : " + "  "  +  deviceUDIDAndroidRebootingListText)
			}
		}
		else{
