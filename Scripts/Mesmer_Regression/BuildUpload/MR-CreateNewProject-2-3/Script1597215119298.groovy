...
// MR-CreateNewProject-2 | Android Physical | Verify that user should see title and text "Upload App" and " Drag and drop your .APK here or Browse Files" on popup
// MR-CreateNewProject-3 | Android Virtual | Verify that user should see title and text "Upload App" and " Drag and drop your .APK with x86 flag enabled here or Browse Files" on popup
