													...
													if(WebUI.waitForElementVisible(projectNameField, 20)==true){
														...
														WebUI.delay(5)
															...
															if(WebUI.waitForElementPresent(toogleSwitch, 20)){
																MesmerLogUtils.logInfo("toogle switch option is available for Non Mesmer user")
															
//																WebUI.click(toogleSwitch)
//																WebUI.delay(5)
															}else{
																MesmerLogUtils.logInfo("toogle switch option is not available for Non Mesmer user")
															}
